...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    posts = GetPostSerializer(
        include_author = False, 
        many = True)

    liked_posts = LikedPostSerializer(
        many = True)
...
class CommentSerializer(serializers.ModelSerializer):
    author = ProfileSerializer(only_user = True, required = False)
...
class ChatSerializer(serializers.ModelSerializer):
    ...
    oppositeUserId = serializers.SerializerMethodField(
        'get_opposite_user_id')
